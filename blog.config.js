...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '春在JustSpring', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '东方植物头皮护理品牌，用植物的天生愈力，为头皮提供生命源初的修复力、防御力、生长力。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.justspring.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '春在，JustSpring，官网', // 网站关键词 英文逗号隔开
