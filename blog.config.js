...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '穿夹脚拖的猫', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一本探索世界的旅程日志', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.exploration.live', // 网站地址
